...
public static partial class WindowCompositionHelper
{
    [LibraryImport("user32.dll")]
    public static partial int SetWindowCompositionAttribute(IntPtr hwnd, ref WindowCompositionAttribData data);
}
